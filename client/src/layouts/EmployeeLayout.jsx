...
import { CalendarCheck, CalendarPlus, LayoutDashboard, LogOut, ReceiptText, UserRound } from "lucide-react";
import { useEmployeeAuth } from "../context/EmployeeAuthContext";
import AppFooter from "../components/AppFooter";
const links = [["/employee/dashboard", "Dashboard", LayoutDashboard], ["/employee/attendance", "My Attendance", CalendarCheck], ["/employee/leave", "My Leave", CalendarPlus], ["/employee/payslips", "My Payslips", ReceiptText], ["/employee/profile", "My Profile", UserRound]];
